...
export type LottieOptions = Omit<AnimationConfigWithPath, 'container'> & {
  lottieRef?: LottieRef;
...
export type PartialLottieOptions = Omit<LottieOptions, 'path'> & {
...
export type PartialLottieComponentProps = Omit<LottieComponentProps, 'path'> & {
  animationData?: LottieOptions['path'];
};
